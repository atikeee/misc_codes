...
DEFAULT_CONFIG = {
    ...
    "colour":  {"brightness": 1.08,  # subtle lift for any remaining darkness
                "contrast":   1.05,  # slight punch to compensate lifted shadows
                "saturation": 1.15,  # warm skin tones for portrait
    ...
    try:
        with rawpy.imread(str(source)) as raw:
            ...
            rgb = raw.postprocess(
                ...
                bright=1.3,        # exposure lift (~+0.4 stops), tweak in config
                exp_shift=0.5,     # highlight-safe exposure shift
            )
